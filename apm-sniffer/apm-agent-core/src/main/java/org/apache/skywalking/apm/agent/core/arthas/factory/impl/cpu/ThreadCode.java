...
public class ThreadCode extends ArthasHttpFactory<ArthasExecDTO, ArthasBaseDTO<JSONObject>> {
    @Override
    public ArthasBaseDTO<JSONObject> execute(ArthasExecDTO arthasExecDTO) throws IOException {
        ArthasExecDTO request = new ArthasExecDTO()
                .setCommand(ArthasConstant.COMMAND_THREAD + arthasExecDTO.getCommand())

...
package org.apache.skywalking.apm.agent.core.arthas.factory.impl.system;
...
public class VmOption extends ArthasHttpFactory<ArthasExecDTO, ArthasBaseDTO<JSONObject>> {
    @Override
    public ArthasBaseDTO<JSONObject> execute(ArthasExecDTO arthasExecDTO) throws IOException {
        ArthasExecDTO request = new ArthasExecDTO()
                .setCommand(ArthasConstant.COMMAND_VM_OPTION)
